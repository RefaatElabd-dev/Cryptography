...
attack.guess_key()
print(attack.key)
message = decrypt(attack.key, cipher)
cipher_lines = cipher.splitlines()
message_lines = message.splitlines()
for line in range(len(message_lines)):
    print(f"p: {message_lines[line]}")
    print(f"c: {cipher_lines[line]}")
    print()
print()
print()
print(message)
